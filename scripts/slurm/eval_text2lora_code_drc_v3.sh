#!/bin/bash
#SBATCH --job-name=t2l-code-drc-eval
...
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=logs/text2lora_code_drc_v3_eval_%j.out
#SBATCH --error=logs/text2lora_code_drc_v3_eval_%j.err
...
echo "==== Text2LoRA Code-Conditioned + DRC v3 Evaluation ===="
...
for SPLIT in cr_test ir_test; do
    ...
    python baselines/text2lora/evaluate_text2lora_code.py \
        ...
        --output "$BASELINES_DIR/text2lora_code_drc_v3_${SPLIT}.json" \
        --batch-size 8
done
