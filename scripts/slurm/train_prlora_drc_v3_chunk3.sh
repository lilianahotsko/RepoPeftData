#!/bin/bash
#SBATCH --job-name=prlora_drc_c3
#SBATCH --output=slurm_logs/prlora_drc_v3_chunk3_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_chunk3_%j.err
...
echo "===== Per-repo LoRA + DRC v3 chunk 3: repos 224-335 ====="
echo "Start: $(date)"
