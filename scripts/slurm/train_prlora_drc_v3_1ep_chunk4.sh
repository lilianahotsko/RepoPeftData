#!/bin/bash
#SBATCH --job-name=prlora1e_c4
#SBATCH --output=slurm_logs/prlora_drc_v3_1ep_chunk4_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_1ep_chunk4_%j.err
...
echo "===== Per-repo LoRA + DRC v3 1-epoch chunk 4: repos 336+ ====="
echo "Start: $(date)"
