#!/bin/bash
# Create oracle_lora_drc_v3 symlinks for Text2LoRA training.
# Run this after per-repo LoRA + DRC v3 training completes.
#
# Usage: bash scripts/slurm/setup_oracle_lora_drc_v3.sh

set -euo pipefail

SRC_BASE="$SCRATCH/TRAINING_CHECKPOINTS/PER_REPO_LORA_DRC_V3_8K"
DST_BASE="text2lora/train_outputs/sft/oracle_lora_drc_v3"

mkdir -p "$DST_BASE"

count=0
for repo_dir in "$SRC_BASE"/*/; do
    # repo_dir is e.g. .../PER_REPO_LORA_DRC_V3_8K/author/
