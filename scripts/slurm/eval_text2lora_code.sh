...
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=logs/text2lora_code_eval_%j.out
#SBATCH --error=logs/text2lora_code_eval_%j.err
...
echo "==== Text2LoRA Code-Conditioned Evaluation ===="
