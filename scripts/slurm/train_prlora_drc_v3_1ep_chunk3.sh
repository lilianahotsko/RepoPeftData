#!/bin/bash
#SBATCH --job-name=prlora1e_c3
#SBATCH --output=slurm_logs/prlora_drc_v3_1ep_chunk3_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_1ep_chunk3_%j.err
...
echo "===== Per-repo LoRA + DRC v3 1-epoch chunk 3: repos 224+ ====="
echo "Start: $(date)"
