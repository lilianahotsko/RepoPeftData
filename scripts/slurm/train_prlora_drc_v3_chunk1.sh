#!/bin/bash
#SBATCH --job-name=prlora_drc_c1
#SBATCH --output=slurm_logs/prlora_drc_v3_chunk1_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_chunk1_%j.err
...
echo "===== Per-repo LoRA + DRC v3 chunk 1: repos 0-111 ====="
echo "Start: $(date)"
