#!/bin/bash
#SBATCH --job-name=prlora1e_c1
#SBATCH --output=slurm_logs/prlora_drc_v3_1ep_chunk1_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_1ep_chunk1_%j.err
...
echo "===== Per-repo LoRA + DRC v3 1-epoch chunk 1: repos 0+ ====="
echo "Start: $(date)"
