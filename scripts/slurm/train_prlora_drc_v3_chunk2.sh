#!/bin/bash
#SBATCH --job-name=prlora_drc_c2
#SBATCH --output=slurm_logs/prlora_drc_v3_chunk2_%j.out
#SBATCH --error=slurm_logs/prlora_drc_v3_chunk2_%j.err
...
echo "===== Per-repo LoRA + DRC v3 chunk 2: repos 112-223 ====="
echo "Start: $(date)"
